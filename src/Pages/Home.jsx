...
const WORDS = ["Software & Game Developer", "Tech Enthusiast"];
const TECH_STACK = ["React", "Javascript", "C++", "Python"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Avery-13" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/avery-ebeling-b1b123302/" },
  { icon: Instagram, link: "https://www.instagram.com/avery.ebeling/" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Crafting Engaging, Interactive, and Technically-Driven Software and Games for Modern Digital Experiences.
                </p>
